 ...
 * EmitterCard - Emitter card component with expandable properties
 */

import React from 'react';
import { motion, AnimatePresence } from 'framer-motion';
import { emitterTypeColors } from '../../ui';
import { Slider, Num, Toggle, Color, Select, Chip } from './MicroControls';
import type {
...
export const LineProps: React.FC<{ em: LineEmitter; onU: (u: Partial<LineEmitter>) => void }> = ({ em, onU }) => (
...
export const CircleProps: React.FC<{ em: CircleEmitter; onU: (u: Partial<CircleEmitter>) => void }> = ({ em, onU }) => (
    <div className="ec-type">
...
export const CurveProps: React.FC<{ em: CurveEmitter; onU: (u: Partial<CurveEmitter>) => void }> = ({ em, onU }) => (
    <div className="ec-type">
...
export const TextProps: React.FC<{ em: TextEmitter; onU: (u: Partial<TextEmitter>) => void }> = ({ em, onU }) => (
    <div className="ec-type">
        <div className="ec-row inline">
...
export const SVGProps: React.FC<{ em: SVGEmitter; onU: (u: Partial<SVGEmitter>) => void }> = ({ em, onU }) => (
    <div className="ec-type">
        <div className="ec-row r3">
...
export const BrushProps: React.FC<{ em: BrushEmitter; onU: (u: Partial<BrushEmitter>) => void }> = ({ em, onU }) => (
    <div className="ec-type">
        <div className="ec-row r4">
...
export interface EmitterCardProps {
    em: Emitter;
    expanded: boolean;
    onToggleExpand: () => void;
